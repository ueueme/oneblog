...
`pushed(created):>2023-11-15 <关键字>`
 更新 或 创建 日期在2023年11月16日之后的带关键字查询
...
# 示例2：搜索描述中包含"小程序"，并且fork大于100，并且最近更新时间在2023-11-15之后的，并且使用开发语言为vue的项目
in:description 小程序 fork:>100 pushed:>2023-11-15 language:vue
```
